            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="modal fade" id="tambahModal" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <form action="{{ route('pegawai.simpanPegawai'); }}" method="POST">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('pegawai.simpanPegawai'); }}" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    <label for="noHp" class="form-label">Nomor Hp</label>
                                                    <input required type="tel" name="noHp" id="noHp"
                                                        value="{{ old('noHp') }}"
                                                        class="form-control @error('noHp') is-invalid @enderror">
                                                    @error('noHp')
                                                    <div class="text-danger">{{ $message }}</div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="cabang" id="cabang" class="form-control"
                                                        ...
                                                        <option value="Jakarta"
                                                            {{ old('cabang')=='Jakarta' ? 'selected' : '' }}>Jakarta
                                                        </option>
                                                        <option value="Papua"
                                                            {{ old('cabang')=='Papua' ? 'selected' : '' }}>
                                                            Papua</option>
                                                        <option value="Jawa Barat"
                                                            {{ old('cabang')=='Jawa Barat' ? 'selected' : '' }}>Jawa
                                                            Barat
                                                        </option>
                                                    </select>
                                                    @error('cabang')
                        ...
                        <!-- Delete Modal-->
                        <div class="modal fade" id="deleteModal-{{ $peg->id }}" aria-labelledby="exampleModalLabel"
                            aria-hidden="true">
                                        ...
                                        <tr>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="cabang" id="cabang" class="form-control">
                                                    ...
                                                    <option value="Papua"
                                                        {{ old('cabang')=='Papua' ? 'selected' : '' }}>Papua</option>
                                                    <option value="Jawa Barat"
                                                        {{ old('cabang')=='Jawa Barat' ? 'selected' : '' }}>Jawa Barat
                                                    </option>
                                                </select>
